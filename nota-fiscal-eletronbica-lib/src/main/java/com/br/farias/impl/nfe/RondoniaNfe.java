...
public class RondoniaNfe implements NotaFiscalEletronica {

	private String BREAK_LINE = "\n";
	private BigDecimal ALI_ICMS_INT = new BigDecimal("0.175");//17,5%
	...
	public void gerarNfe(NotaFiscal notaFiscal) {
		...
		.append("====================== Nota Fiscal Eletronica - RO ==========================").append(BREAK_LINE)
		.append("=============================================================================").append(BREAK_LINE)		
